...
RESULT_DIR = Path(f"vqa_benchmark_ft/{Path(MODEL_ID).name}-qwen-benchmark-LORA-vqa")
...
if __name__ == "__main__":
    ...
    trainer.train()
    # model.save_pretrained(RESULT_DIR / "adapter")  # save LoRA adapter only
    # processor.save_pretrained(RESULT_DIR / "adapter")

    # Optional: fuse LoRA back into base weights for standalone model
    # merged = model.merge_and_unload()
    # merged.save_pretrained(RESULT_DIR / "merged-full")
